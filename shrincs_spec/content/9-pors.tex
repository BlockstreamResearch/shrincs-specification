...
\begin{verbatim}
    ...
    3. min_blk ← roundup(roundup(2^b * k / t)/c) // expected number of XOF blocks
    4. indices ← []
    5. xof_out ← ""
...
where \texttt{total\_bits = (roundup(2\string^b * k / t) + margin) * b + offset + hsl} is the length of the XOF output (see Section~5.4.2). 
